  ...
  return (
       ...
       <div>
            ...
            <input type="number" name="productPrice" id="productPrice" min={0} max={500} style={{padding : '0 15px'}} value={filteredproduct.productPrice} onChange={(e)=>handleChange(e.target.value,'pp')}/>
              ...
              <div className="flex w-full justify-center items-center md:justify-start md:items-start">
                <button className="mt-6 md:mt-0 dark:bproduct-white dark:hover:bg-gray-900 dark:bg-transparent dark:text-white py-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 bproduct bproduct-gray-800  w-96 2xl:w-full text-base font-medium leading-4 text-gray-800" style={{marginTop:'10px',backgroundColor:'red',color:'white'}} onClick={deleteproduct} >Delete product</button>
